...
1. Diffuser: prompt → PIL.Image
2. Evaluator: (current_img, generated_img) → pixel proposals
3. (Optional) Classifier: image → feature embeddings
...
class LocalRegionPipeline:
    """
    End-to-end composition: prompt → image → evaluation → proposals.

    Stateless integration of Diffuser and Evaluator.
    """
    ...
    def process_prompt_against_canvas(
        ...
        """
        End-to-end pipeline: prompt → generated image → proposals.
